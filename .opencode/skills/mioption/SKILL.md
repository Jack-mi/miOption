...
Cursor loads this skill from `.cursor/skills/mioption/`. OpenCode loads it from
`.opencode/skills/mioption/` and FastMCP from repo `opencode.json`. The vault-map
H5 talks to `opencode serve`, not to Cursor.
