...
Default runtime agent harness remains Claude Agent SDK (2026-09-04). Codex is an optional stdio-MCP overlay. Strategy Q&A still uses concepts and the 27 entities.
...
- Clarified harness split on [[Futu OpenAPI integration]] and [[Product patterns]].
