...
A bear call spread is a type of vertical spread. It contains two calls with the same expiration but different strikes. The strike price of the short call is below the strike of the [long call](https://www.optionseducation.org/strategies/all-strategies/long-call), which means this strategy will always generate a net cash inflow (net credit) at the outset.
...
![Bear Call Spread P&L chart; Short 60 call (green dot), Long 65 call (red dot); Max profit below 60, Max loss above 65](https://www.optionseducation.org/getmedia/6b7e85e9-ebbb-47a4-8478-8ddca88fce36/Bear-Call-Spread-PnL_final_approved.png?width=260&height=260 "Bear Call Spread P&L chart; Short 60 call (green dot), Long 65 call (red dot); Max profit below 60, Max loss above 65")
...
A vertical call spread can be a bullish or bearish strategy, depending on how the strike prices are selected for the long and short positions. See [bull call spread](https://www.optionseducation.org/strategies/all-strategies/bull-call-spread-debit-call-spread) for the bullish counterpart.
...
Comparable Position: [Bear Put Spread](https://www.optionseducation.org/strategies/all-strategies/bear-put-spread)

Opposite Position: [Bull Call Spread](https://www.optionseducation.org/strategies/all-strategies/bull-put-spread-credit-put-spread)